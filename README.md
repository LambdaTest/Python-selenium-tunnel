# Run Python Selenium Tests With Tunnel on TestMu AI (Formerly LambdaTest)
...
If you want to run an automation test in Python-selenium on TestMu AI (Formerly TestMu AI (Formerly LambdaTest)) using the tunnel and want to start the tunnel automatically in the script, you can use the following steps.
